                                ...
                                <div class="col-md-10">
                                    <div class="topic-content pull-right">
                                        ...
                                        <div class="topic-info">
                                            <a href="topics.php?category=<?php echo urlencode($topic->category_id);?>"><?php echo $topic->name;?></a> >> <a href="topics.php?user=<?php echo $topic->user_id;?>"><?php echo $topic->username;?></a> >><?php echo  formatDate($topic->create_date);?>
